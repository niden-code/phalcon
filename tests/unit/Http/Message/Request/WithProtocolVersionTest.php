...
final class WithProtocolVersionTest extends AbstractUnitTestCase
{
     ...
     * @since  2019-02-10
     */
    public function testHttpMessageRequestWithProtocolVersion()
    {
        $request = new Request();
     ...
     * @since  2019-02-10
     */
    public function testHttpMessageRequestWithProtocolVersionEmpty()
    {
     ...
     * @since  2019-02-10
     */
    public function testHttpMessageRequestWithProtocolVersionUnsupported()
    {
        $this->expectException(InvalidArgumentException::class);
