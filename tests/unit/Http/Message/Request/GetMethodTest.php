...
final class GetMethodTest extends AbstractUnitTestCase
{
     ...
     * @since  2019-02-10
     */
    public function testHttpMessageRequestGetMethod()
    {
     ...
     * @since  2019-02-10
     */
    public function testHttpMessageRequestGetMethodEmpty()
    {
        $request = new Request();
     ...
     * @since  2019-02-10
     */
    public function testHttpMessageRequestGetMethodWxception()
    {
