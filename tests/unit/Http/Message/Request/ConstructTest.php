...
final class ConstructTest extends AbstractUnitTestCase
{
     ...
     * @since  2019-02-08
     */
    public function testHttpMessageRequestConstructExceptionBody()
    {
     ...
     * @since  2019-02-08
     */
    public function testHttpMessageRequestConstructExceptionHeaders()
    {
        $this->expectException(InvalidArgumentException::class);
     ...
     * @since  2019-02-08
     */
    public function testHttpMessageRequestConstructExceptionUri()
    {
        $this->expectException(InvalidArgumentException::class);
     ...
     * @since  2019-02-08
     */
    public function testHttpMessageRequestConstructHeadersWithHost()
    {
        $request = new Request(
            'GET',
