...
final class GetHeadersTest extends AbstractUnitTestCase
{
     ...
     * @since  2019-02-10
     */
    public function testHttpMessageRequestGetHeaders()
    {
        $data = [
     ...
     * @since  2019-02-10
     */
    public function testHttpMessageRequestGetHeadersCollection()
    {
        $data = [
            'Accept'        => [Http::CONTENT_TYPE_HTML],
            'Cache-Control' => ['max-age=0'],
     ...
     * @since  2019-02-10
     */
    public function testHttpMessageRequestGetHeadersEmpty()
    {
        $request = new Request();
