...
final class WithAddedHeaderTest extends TestCase
{
     ...
     * @since  2019-02-10
     */
    public function testHttpMessageRequestWithAddedHeader()
    {
        $data = [
     ...
     * @since  2019-02-10
     */
    public function testHttpMessageRequestWithAddedHeaderEmptyValue()
    {
     ...
     * @since  2019-02-10
     */
    public function testHttpMessageRequestWithAddedHeaderMerge()
    {
        $data = [
            'Accept' => [Http::CONTENT_TYPE_HTML],
        ];
     ...
     * @since  2019-02-10
     */
    public function testHttpMessageRequestWithAddedHeaderStringValue()
    {
        $data = [
            'Accept' => [Http::CONTENT_TYPE_HTML],
        ];
