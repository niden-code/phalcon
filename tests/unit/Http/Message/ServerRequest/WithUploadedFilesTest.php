...
final class WithUploadedFilesTest extends TestCase
{
    /**
     ...
     * @since  2019-02-10
     */
    public function testHttpMessageServerRequestWithUploadedFiles()
    {
        $files       = [
     ...
     * @since  2019-02-10
     */
    public function testHttpMessageServerRequestWithUploadedFilesException()
    {
