...
final class WithParsedBodyTest extends TestCase
{
    /**
     ...
     * @since  2019-02-10
     */
    public function testHttpMessageServerRequestWithParsedBody()
    {
     ...
     * @since  2019-02-10
     */
    public function testHttpMessageServerRequestWithParsedBodyException()
    {
