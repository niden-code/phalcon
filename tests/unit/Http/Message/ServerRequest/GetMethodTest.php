...
final class GetMethodTest extends TestCase
{
     ...
     * @since  2019-02-10
     */
    public function testHttpMessageServerRequestGetMethod()
    {
     ...
     * @since  2019-02-10
     */
    public function testHttpMessageServerRequestGetMethodEmpty()
    {
     ...
     * @since  2019-02-10
     */
    public function testHttpMessageServerRequestGetMethodWxception()
    {
