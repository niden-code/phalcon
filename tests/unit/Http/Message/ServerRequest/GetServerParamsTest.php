...
final class GetServerParamsTest extends TestCase
{
    /**
     ...
     * @since  2019-02-10
     */
    public function testHttpMessageServerRequestGetServerParams()
    {
        $params  = ['one' => 'two'];
     ...
     * @since  2019-02-10
     */
    public function testHttpMessageServerRequestGetServerParamsEmpty()
    {
