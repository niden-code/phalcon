 ...
 */
final class LoadTest extends AbstractHttpTestCase
{
    /**
     * @return array
     */
     ...
     * @since  2019-02-09
     */
    public function testHttpMessageServerRequestFactoryLoad()
    {
     ...
     * @issue  15286
     */
    public function testHttpMessageServerRequestFactoryLoadConstructorFromSuperglobals()
    {
        // Backup
        $params = [
     ...
     * @since  2019-02-09
     */
    public function testHttpMessageServerRequestFactoryLoadFiles()
    {
     ...
     * @since  2019-02-09
     */
    public function testHttpMessageServerRequestFactoryLoadFilesException()
    {
     ...
     * @since  2019-02-09
     */
    public function testHttpMessageServerRequestFactoryLoadHeaderCookie()
    {
        $server = [
     ...
     * @since  2019-02-09
     */
    public function testHttpMessageServerRequestFactoryLoadHeaderHost()
    {
        $server = [
     ...
     * @since  2019-02-09
     */
    public function testHttpMessageServerRequestFactoryLoadHeaderHostArray()
    {
        $server = [
            'HTTP_HOST' => [
                'dev.phalcon.ld',
     ...
     * @since  2019-02-09
     */
    public function testHttpMessageServerRequestFactoryLoadIisPath()
    {
        $server = [
     ...
     * @since  2019-02-09
     */
    public function testHttpMessageServerRequestFactoryLoadOriginalPathInfo()
    {
        $server = [
     ...
     * @since  2019-02-09
     */
    public function testHttpMessageServerRequestFactoryLoadProtocolDefault()
    {
        $factory = new ServerRequestFactory();
     ...
     * @since  2019-02-09
     */
    public function testHttpMessageServerRequestFactoryLoadProtocolDefined()
    {
        $factory = new ServerRequestFactory();
        $server  = [
     ...
     * @since  2019-02-09
     */
    public function testHttpMessageServerRequestFactoryLoadProtocolError()
    {
        $this->expectException(InvalidArgumentException::class);
     ...
     * @since  2019-02-09
     */
    public function testHttpMessageServerRequestFactoryLoadProtocolErrorUnsupported()
    {
        $this->expectException(InvalidArgumentException::class);
     ...
     * @since  2019-02-09
     */
    public function testHttpMessageServerRequestFactoryLoadSchemeHttps()
    {
        $factory = new ServerRequestFactory();
        $server  = [
            'HTTPS' => 'on',
     ...
     * @since  2019-02-09
     */
    public function testHttpMessageServerRequestFactoryLoadServerHeader()
    {
        $server = [
     ...
     * @since  2019-02-09
     */
    public function testHttpMessageServerRequestFactoryLoadServerPrefixed()
    {
        $server = [
            'SIMPLE'               => 'Some Cookie',
