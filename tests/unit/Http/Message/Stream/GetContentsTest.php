...
final class GetContentsTest extends AbstractUnitTestCase
{
     ...
     * @since  2019-02-10
     */
    public function testHttpMessageStreamGetContents()
    {
     ...
     * @since  2019-02-10
     */
    public function testHttpMessageStreamGetContentsException()
    {
     ...
     * @since  2019-02-10
     */
    public function testHttpMessageStreamGetContentsFromPosition()
    {
        if (PHP_OS_FAMILY === 'Windows') {
            $this->markTestSkipped('Need to fix Windows new lines...');
        }
