...
final class GetFilteredPostTest extends AbstractHttpTestCase
{
    /**
     * @return array[]
     */
     ...
     * @since  2019-02-01
     */
    public function testHttpRequestGetFilteredDefault()
    {
     ...
     * @since        2019-02-01
     */
    public function testHttpRequestGetFilteredPost1(
        string $method,
        string $name,
        array $filters,
        array $scope,
