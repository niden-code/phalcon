...
final class GetURITest extends AbstractHttpTestCase
{
    /**
     ...
     * @since  2020-03-17
     */
    public function testHttpRequestGetURI()
    {
     ...
     * @since  2020-03-17
     */
    public function testHttpRequestGetURIDefault()
    {
        $request = $this->getRequestObject();
     ...
     * @since  2020-03-17
     */
    public function testHttpRequestGetURIOnlyPath()
    {
        $uri                    = Http::TEST_URI . '?a=b';
        $_SERVER['REQUEST_URI'] = $uri;
