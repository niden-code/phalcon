...
final class GetQueryTest extends AbstractHttpTestCase
{
    /**
     ...
     * @since  2019-12-01
     */
    public function testHttpRequestGetQueryAllowNoEmpty()
    {
        $key = uniqid('key-');
     ...
     * @since  2019-12-01
     */
    public function testHttpRequestGetQueryDefault()
    {
        $key     = uniqid('key-');
        $request = $this->getRequestObject();
     ...
     * @since  2019-12-01
     */
    public function testHttpRequestGetQueryFilter()
    {
        $key        = uniqid('key-');
        $value      = uniqid('VAL-');
        $_GET[$key] = '  ' . $value . '  ';
