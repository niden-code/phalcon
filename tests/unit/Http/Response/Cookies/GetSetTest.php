...
final class GetSetTest extends AbstractHttpTestCase
{
    use CookieTrait;
     ...
     */
    public function testHttpCookieSetHttpOnly()
    {
     ...
     */
    public function testHttpCookieSetOptions()
    {
        $this->setDiService('crypt');
     ...
     * @since  2020-01-06
     */
    public function testHttpResponseCookiesGetSet()
    {
        $name  = uniqid('nam-');
        $value = uniqid('val-');
