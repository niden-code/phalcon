...
final class GetSetHeadersTest extends TestCase
{
    /**
     ...
     * @since  2019-12-08
     */
    public function testHttpResponseGetSetHeaders()
    {
        // Create headers
        $headers = new Headers();
     ...
     * @since  2018-11-13
     */
    public function testHttpResponseSetHeadersEmpty()
    {
        $response = new Response();
        $headers  = new Headers();
     ...
     * @since  2018-11-13
     */
    public function testHttpResponseSetHeadersMerge()
    {
        $response = new Response();
        $headers  = new Headers();
