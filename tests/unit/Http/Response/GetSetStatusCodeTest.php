...
final class GetSetStatusCodeTest extends AbstractHttpTestCase
{
    /**
     ...
     * @since  2021-12-24
     */
    public function testHttpResponseGetSetStatusCode()
    {
        $code = Http::CODE_200;
     ...
     * @since  2014-10-08
     */
    public function testHttpResponseSetStatusCodeSend()
    {
        $response = $this->getResponseObject();
     ...
     */
    public function testHttpResponseSetStatusCodeSendMicro()
    {
        $this->markTestSkipped('Enable with MVC');
