...
final class NumberTest extends AbstractUnitTestCase
{
    ...
    /**
     * Tests Phalcon\Encryption\Security\Random :: number() max
     *
     * @return void
     *
     * @author Phalcon Team <team@phalcon.io>
     * @since  2020-09-09
     */
    public function testEncryptionSecurityRandomNumberMax(): void
    {
    ...
    /**
     * Tests Phalcon\Encryption\Security\Random :: number() min
     *
     * @return void
     *
     * @author Phalcon Team <team@phalcon.io>
     * @since  2020-09-09
     */
    public function testEncryptionSecurityRandomNumberMin(): void
    {
        $this->expectException(Exception::class);
        $this->expectExceptionMessage('Input number must be a positive integer');
