...
use Phalcon\Tests1\Fixtures\Encryption\CryptRandomBytesFixture;
...
final class EncryptTest extends AbstractUnitTestCase
{
    ...
    public function testEncryptionCryptEncryptCannotCalculateRandomPseudoBytes(): void
    {
        ...
        $crypt = new CryptRandomBytesFixture();
     ...
     * @since  2021-10-18
     */
    public function testEncryptionCryptEncryptGcmCcmExceptionWithoutData(): void
    {
        $ciphers = [
            'aes-128-gcm',
            'aes-128-ccm',
