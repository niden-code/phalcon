...
use Phalcon\Tests1\Fixtures\Storage\Serializer\Base64DecodeFixture;
use Phalcon\Tests1\Fixtures\Storage\Serializer\IgbinarySerializeFixture;
use Phalcon\Tests1\Fixtures\Storage\Serializer\IgbinaryUnserializeFixture;
use Phalcon\Tests1\Fixtures\Storage\Serializer\IgbinaryUnserializeWarningFixture;
use stdClass;
...
final class ExceptionsTest extends AbstractUnitTestCase
{
    ...
    {
        $serializer = new IgbinaryUnserializeWarningFixture();
