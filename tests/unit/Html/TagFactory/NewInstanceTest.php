...
final class NewInstanceTest extends AbstractUnitTestCase
{
     ...
     * @since  2020-09-09
     */
    public function filterTagFactoryNewInstanceException(): void
    {
        $name = uniqid();
    ...
    /**
     * Tests Phalcon\Storage\SerializerFactory :: newInstance() - exception constructor
     *
     * @return void
     *
     * @author Phalcon Team <team@phalcon.io>
     * @since  2020-09-09
     */
    public function filterTagFactoryNewInstanceExceptionConstructor(): void
    {
        $name = uniqid();
        $this->expectException(Exception::class);
        $this->expectExceptionMessage('Service ' . $name . ' is not registered');
