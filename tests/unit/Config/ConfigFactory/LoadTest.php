...
final class LoadTest extends AbstractUnitTestCase
{
    ...
    /**
     * Tests Phalcon\Config\ConfigFactory :: load() -  exception file path
     *
     * @return void
     *
    ...
    /**
     * Tests Phalcon\Config\ConfigFactory :: load() -  exception file path factory
     *
     * @return void
     *
     * @author Phalcon Team <team@phalcon.io>
     * @since  2019-06-19
     */
    public function testConfigFactoryLoadExceptionFilePathFactory(): void
    {
        $this->expectException(Exception::class);
        $this->expectExceptionMessage(
