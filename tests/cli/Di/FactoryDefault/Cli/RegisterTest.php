...
class RegisterTest extends AbstractCliTestCase
{
    /**
    ...
    {
        require_once self::dataDir('fixtures/Di/SomeComponent.php');
        require_once self::dataDir('fixtures/Di/SomeServiceProvider.php');
